...
export const componentsActions: IComponentsActions = {
  ...
  buttonClassName: (payload: string): TComponentsActions => action({ type: EComponentsActionTypes.BUTTON_EXTERNAL_CLASS, payload }),
  ...
  paginationClassName: (payload: string): TComponentsActions => action({ type: EComponentsActionTypes.PAGINATION_EXTERNAL_CLASS, payload }),
