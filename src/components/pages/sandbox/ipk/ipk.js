...
export const IPK = ({
  ...
  const calc = ({
    ...
    первоначальныйВзнос = первоначальныйВзнос < первоначальныйВзносМин
      ? первоначальныйВзносМин : первоначальныйВзнос
  ...
  const первоначальныйВзносПроцентДействие = e => {
        ...
        <tr>
          ...
          <td className="range-flex">
            <input
              ...
              onInput={первоначальныйВзносПроцентДействие}
            />
            <span>
