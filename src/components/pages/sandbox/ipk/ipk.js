...
export const IPK = ({
  ...
  const минПервоначальныйВзносПроценты = 15
  ...
  const первоначальныйВзносМин1 = стоимостьЖильяЗначение1 * минПервоначальныйВзносПроценты / 100
  const первоначальныйВзносМин2 = стоимостьЖильяЗначение2 * минПервоначальныйВзносПроценты / 100
